"""Fill the lecturer's cover template and convert it to PDF (Phase 12).

Targets HW5 (exercise number = 5, ex05 repo URL). Field values come from the
...
--template <docx> --output ~/COSMOS77/HW5/COSMOS77-ex05.pdf --exercise-number 5``.
"""
...
_REPO_URL = "https://github.com/AbdallahKhaldi/COSMOS77-ex05"
_STUDENTS = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Generate the COSMOS77-ex05 cover PDF.")
    parser.add_argument("--template", required=True, type=Path)
    parser.add_argument("--output", required=True, type=Path)
    parser.add_argument("--self-score", type=int, default=85)
    parser.add_argument("--exercise-number", type=int, default=5)
